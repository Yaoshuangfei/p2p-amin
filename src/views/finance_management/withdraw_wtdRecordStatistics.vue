<template>
    <section>
        ...
        <el-table :data="list" highlight-current-row v-loading="listLoading" border style="width: 100%;min-width: 1080px;">
            ...
            <el-table-column prop="transDate"  label="到账日期">
            </el-table-column>
            <el-table-column prop="transMoney"  label="提现金额">
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getlist(){
                ...
                //     _this.payTimeEt = ''
                // }
                let url = baseUrl+'/pay/paytransstatistics/statistics?pageSize=10&type=2&token='+_this.token+'&page='+_this.page
                // if(this.value !== '' && this.value[0] !== null){
